...
PryceGroup:
	...
	db 30, DEWGONG,    SURF, ICY_WIND, AURORA_BEAM, REST
	db 31, PILOSWINE,  ICY_WIND, ANCIENTPOWER, MIST, BLIZZARD
	db -1 ; end
...
JasmineGroup:
	...
	db 30, MAGNEMITE,  THUNDERBOLT, SUPERSONIC, SONICBOOM, THUNDER_WAVE
	db 35, STEELIX,    SCREECH, CURSE, ROCK_THROW, IRON_TAIL
	db -1 ; end
...
ClairGroup:
	...
	db 37, DRAGONAIR,  THUNDER_WAVE, SURF, RAIN_DANCE, DRAGONBREATH
	db 37, DRAGONAIR,  THUNDER_WAVE, THUNDERBOLT, LIGHT_SCREEN, DRAGONBREATH
	db 37, DRAGONAIR,  TOXIC, ICE_BEAM, REST, DRAGONBREATH
	db 40, KINGDRA,    AURORA_BEAM, SURF, HYPER_BEAM, DRAGONBREATH
	db -1 ; end
...
BrunoGroup:
	...
	db 43, ONIX,       BIND, EARTHQUAKE, SHARPEN, ROCK_SLIDE
...
KarenGroup:
	...
	db 42, UMBREON,    PURSUIT, CONFUSE_RAY, FAINT_ATTACK, MEAN_LOOK
	db 42, VILEPLUME,  STUN_SPORE, ACID, MOONLIGHT, PETAL_DANCE
	db 45, GENGAR,     SHADOW_BALL, SPITE, ICE_PUNCH, DESTINY_BOND
...
KogaGroup:
	...
	db 43, FORRETRESS, REFLECT, SWIFT, EXPLOSION, SPIKES
...
ChampionGroup:
	...
	db 46, AERODACTYL, WING_ATTACK, ANCIENTPOWER, EARTHQUAKE, HYPER_BEAM
